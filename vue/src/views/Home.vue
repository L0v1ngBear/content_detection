  ...
  <div class="ai-detect-home">
    ...
    <div class="home-features">
      ...
      <div class="features-container">
        <div class="feature-card" @click="handleNavigate('text-detect')">
          <div class="feature-icon text-icon">
            <svg viewBox="0 0 24 24" fill="#409eff" class="icon-svg">
              <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zM6 20V4h7v5h5v11H6z" />
            </svg>
          </div>
          <h3 class="feature-title">文本违规检测</h3>
          <p class="feature-desc">精准识别文本中的血腥暴力、色情低俗、辱骂攻击、违禁信息等违规内容，支持批量检测与合规分析</p>
          <div class="feature-tags">
            <span class="tag">准确率99.2%</span>
